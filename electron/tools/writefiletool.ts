...
export const writefiletool = tool(
  ...
  },
  {
    name: "write_file",
    description:
      "Write or append text content to a file within the project directory. Creates parent directories if needed. Can overwrite or append.",
    schema: z.object({
      filepath: z
        .string()
      ...
      append: z
        .boolean()
        .optional()
        .describe("If true, append to existing file instead of overwriting (default: false)"),
    }),
  },
);
