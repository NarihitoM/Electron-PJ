...
export const systeminfotool = tool(
    async () => {
        try {
            const info = {
                ...
                cpus: os.cpus().length > 0 ? `${os.cpus()[0].model} (${os.cpus().length} cores)` : "Unknown",
    ...
    },
    {
        ...
        description: "Get system information including OS, platform, architecture, CPU, memory, hostname, and uptime.",
        schema: z.object({})
    }
);
