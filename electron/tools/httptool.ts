...
export const httptool = tool(
  ...
  },
  {
    name: "http_request",
    description:
      "Make HTTP/HTTPS requests to external APIs and websites. Supports GET, POST, PUT, PATCH, DELETE. Custom headers and body are supported. Response is truncated at 100KB. Internal/private IPs are blocked for security.",
    schema: z.object({
