...
import { ProviderGrid } from "@/features/dashboard/components/ProviderGrid"
import { ServiceGrid } from "@/features/dashboard/components/ServiceGrid"
    ...
    return (
        <div className="flex h-[92vh] w-full flex-col bg-background">
            ...
            <div className="mx-auto w-full max-w-5xl grid grid-cols-2 mt-4 gap-3">
                <StatCards stats={stats ?? null} loading={isLoading} error={isError} onRetry={() => refetch()} />
            </div>
            ...
            <div className="mx-auto w-full max-w-5xl mt-5">
                ...
                <div className="mx-auto w-full max-w-5xl mt-4">
                    <ProviderGrid loading={isLoading} />
                </div>
                <Separator className="mt-5" />
