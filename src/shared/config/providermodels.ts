...
export const PROVIDER = [
  {
    ...
    description: "Powerful multimodal AI for chat, coding and reasoning.",
  },
  {
    name: "Anthropic",
    model: "Claude Series",
    image: BRAND_ASSETS["anthropic"],
    description: "Long-context models focused on analysis and coding.",
  },
  {
    name: "Google Gemini",
    model: "Gemini Series",
    image: BRAND_ASSETS["gemini"],
    description: "Fast multimodal AI with search integration.",
  },
  {
    name: "Groq",
    model: "Ultra-fast inference",
    image: BRAND_ASSETS["groq"],
    description: "Very low-latency AI responses for real-time apps.",
  },
  {
    name: "OpenRouter",
...
function inferCapabilities(id: string): string[] {
  ...
  if (
    /vl|vision|image|multimodal|visual|pixtral|sonnet|opus|haiku|glm.*v[^a-z]|gpt-4|gpt-5|gemini|claude/.test(
      lower,
    )
  )
    caps.push("vision");
