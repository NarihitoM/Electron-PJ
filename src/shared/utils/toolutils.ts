export const extractToolMessage = (query: unknown): string | null => {
    ...
    if (typeof query === "object") {
        const contentFields = ["message", "content", "body", "query", "text", "prompt", "input", "description"];
...
export const getToolBadgeText = (tool: { name: string; query: unknown }, toolMap: Record<string, string>): string => {
