...
export const ToolApprovalDialog = ({ open, toolName, toolQuery, onApprove, onReject }: ToolApprovalDialogProps) => {
    return (
            ...
            <DialogContent>
                ...
                <div className="flex flex-col gap-3">
                    <div className="flex flex-col gap-1">
                        ...
                        <span className="text-sm text-muted-foreground">{WRITE_TOOLS_LABELS[toolName] || toolName}</span>
                    </div>
