    ...
    return (
        <>
            <Card className="hover:border-cyan-500/50 hover:border transition-all hover:shadow-md cursor-pointer">
                ...
                <CardContent>
                    <h1 className="text-2xl font-bold text-zinc-700 dark:text-white">{stats?.totalAgentNodes ?? 0}</h1>
                </CardContent>
            </Card>
            <Card className="hover:border-cyan-500/50 hover:border transition-all hover:shadow-md cursor-pointer">
                <CardHeader>
                ...
                <CardContent>
                    <h1 className="text-2xl font-bold text-zinc-700 dark:text-white">{stats?.totalChats ?? 0}</h1>
                </CardContent>
            </Card>
            <Card className="hover:border-cyan-500/50 hover:border transition-all hover:shadow-md cursor-pointer">
                <CardHeader>
                ...
                <CardContent className="flex justify-between items-center">
                    <h1 className="text-2xl font-bold text-zinc-700 dark:text-white">{stats?.activeProviders?.length ?? 0}</h1>
                    <div className="flex">
                        <AvatarGroup>
            ...
            <Card className="hover:border-cyan-500/50 hover:border transition-all hover:shadow-md cursor-pointer">
                ...
                <CardContent className="flex justify-between items-center">
                    <h1 className="text-2xl font-bold text-zinc-700 dark:text-white">{stats?.connectedServices?.length ?? 0}</h1>
                    <div className="flex">
                        <AvatarGroup>
