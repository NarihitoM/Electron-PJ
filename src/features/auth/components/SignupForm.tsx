...
export const SignupForm = () => {
    ...
    return (
        <div className="rounded-lg flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 relative">
                <button type="button" onClick={() => setshow2(prev => !prev)} className="absolute right-3 top-7.5 text-muted-foreground">
                    {!show2 ? <EyeOff size={18} /> : <Eye size={18} />}
                </button>
                <Label htmlFor="CPassword"><Lock size={15} />Confirm Password</Label>
                <Input value={userconfirmpassword} onChange={(e) => setuserconfirmpassword(e.target.value)} id="Cpassword" type={show2 ? "text" : "password"} placeholder="Enter Confirm Password" className="pr-12" />
            </div>
            ...
            <div className="w-full">
                <Button disabled={loading} onClick={handleSignup} className="bg-cyan-500 dark:bg-white w-full">
            ...
            <div className="w-full gap-2 flex justify-center items-center mt-5">
                <Checkbox id="terms" checked={isAgreed} onCheckedChange={(checked) => setIsAgreed(checked === true)} />
                <div className="flex items-center text-[12px] text-muted-foreground">
                    ...
                    <a href="https://www.google.com" target="_blank" rel="noreferrer" className="ml-1 text-cyan-500 dark:text-white hover:underline font-medium">terms and conditions.</a>
                </div>
            </div>
        </div>
    );
