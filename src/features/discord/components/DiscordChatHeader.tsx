...
export const DiscordChatHeader = () => {
  const { provider, setProvider } = discordauthstore();
  const { data: Api = [] } = useServiceKeys();
  const { data: discordAccount, isLoading: loadingdiscord } = useDiscordAccount();
    ...
    <div className="mx-auto w-full max-w-5xl flex justify-between gap-1">
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground">
          You can edit and send message with your discord agent.
        </p>
      </div>
