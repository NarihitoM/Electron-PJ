...
import { chatsession, ToolCallSignal } from "@/shared/types/globaltype";
    ...
    if (!sessionmessage || sessionmessage.length === 0) {
        return (
            <div className="min-h-[50vh] flex flex-col gap-2 justify-center items-center">
                ...
                {!telegramuserdata && <Button className="bg-cyan-500 dark:bg-white" onClick={onOpenCreate}>Add Telegram Account</Button>}
            </div>
        );
    }
                        ...
                        <div className="flex h-8 w-8 items-center justify-center rounded-full mt-1">
                            {isUser ? (
                                ...
                                <div className="relative flex items-center justify-center">
                                    {sending && isLastMessage && !msg.content && (!msg.toolsCall || msg.toolsCall.length === 0 || msg.toolsCall.some((t: ToolCallSignal) => t.status === "loading")) ? (
