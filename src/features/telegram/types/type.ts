...
export interface createTelegram {
  ...
  telegramcreate: (phone: string, password: string) => Promise<telegramfeedback>;
  ...
  telegramverify: (phonecode: string) => Promise<returntelegramfeedback>;
  fetchtelegrammessage: (cursor?: string, limit?: number) => Promise<returntelegrammessage>;
  telegramcroncreate: (data: telegramcrondata) => Promise<returntelegramfeedback>;
