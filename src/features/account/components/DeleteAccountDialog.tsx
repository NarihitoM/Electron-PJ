      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription className="space-y-2 text-left">
            <p>
              This action will schedule your account for <b>permanent deletion</b>.
            </p>
            <p>
              Your account and all associated data (chats, messages, service connections) will be
              permanently deleted after <b>30 days</b>.
            </p>
            <p className="text-sm text-muted-foreground">
              You can cancel this at any time by logging back in before the 30-day period ends.
            </p>
          </DialogDescription>
        </DialogHeader>
