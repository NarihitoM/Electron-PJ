...
export const N8nMessageList = () => {
  ...
  const userperson = (
    <Avatar className="w-7 h-7 dark:border-2 border-black">
      ...
      <AvatarFallback className="dark:bg-neutral-700 dark:text-neutral-300">
      ...
      <div className="flex-1 overflow-y-auto p-4" ref={scrollContainerRef}>
        <div className="mx-auto max-w-3xl text-center mt-20">
          ...
          <p className="text-muted-foreground mb-6">
            There was an error loading your chat messages. Please try again.
          </p>
          <Button onClick={fetchMessages} variant="default" size="lg" className="cursor-pointer">
                    ...
                    <div className="flex flex-wrap gap-2 mb-2">
                      {mes.images.map((img, i) => (
                        <img
                          ...
                          onClick={() => {
                            store.setLightboxImages(mes.images!);
                          ...
                          if (extracted && !mes.toolsCall?.length) {
                            return (
                              <div className="text-sm whitespace-pre-wrap wrap-break-word">
                                {mes.thinking && (
                                  <ThinkingBlock
                                    thinking={mes.thinking}
                                    isStreaming={
                                      store.sending && index === store.sessionmessage.length - 1
                                    }
                                  />
                                )}
                                <AiContent content={extracted} />
                              </div>
                            );
                          }
                          return (
                    ...
                    <div className="flex flex-wrap gap-2">
                      {mes.generatedImages.map((url, i) => (
                        <div
                          ...
                          onClick={() => {
                            store.setLightboxImages(mes.generatedImages!);
                            store.setLightboxIndex(i);
                            store.setLightboxOpen(true);
                          }}
                        >
                          ...
                          <div
                            ...
                            onClick={(e) => {
                              ...
                              store.setCopiedIndex(i);
                              setTimeout(() => store.setCopiedIndex(null), 2000);
                            }}
                          >
            ...
            <div className="bg-muted rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm">
              <div className="flex items-center gap-2">
                ...
                <span className="flex gap-0.5">
                  <span
                    className="w-1 h-1 rounded-full bg-foreground animate-bounce"
