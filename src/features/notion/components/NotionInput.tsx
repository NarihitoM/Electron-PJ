          ...
          <div className="flex gap-2 items-center">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" side="top" className="w-40">
                ...
                <DropdownMenuItem onClick={() => store.settype("edit")}>
                  <Box /> Edit Data
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => store.settype("createsubpage")}>
                  <Box /> Create Subpage
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => store.settype("updatetitle")}>
                  <Box /> Update Title
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => store.settype("database")}>
                  <Box /> Database
                </DropdownMenuItem>
              </DropdownMenuContent>
            </DropdownMenu>
