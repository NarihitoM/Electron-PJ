...
export interface createchat {
  ...
  resetchat: () => void;
  createchat: () => Promise<authchatfeedback>;
  fetchchat: (cursor?: string) => Promise<void>;
  deletechat: (chatid: string) => Promise<authchatfeedback>;
  sendmessage: (
    chatid: string,
    provider: string,
    model: string,
  ...
  fetchmessage: (chatid: string, cursor?: number, limit?: number) => Promise<authmessagedata>;
}
