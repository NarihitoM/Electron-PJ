  ...
  return (
    <Collapsible className="w-full max-w-[95%] space-y-2">
      <CollapsibleTrigger asChild>
        <Button className="group flex items-center gap-2 px-3 py-1 rounded-full border text-[10px] font-bold transition-all hover:bg-zinc-50 active:scale-95 text-black dark:text-white border-zinc-100 dark:border-zinc-800 bg-white dark:bg-card shadow-sm">
          ...
          {chain.input && (
            <div className="border-b border-zinc-200 dark:border-zinc-800">
              ...
              <div className="p-3 overflow-x-auto scrollbar-hide">
                <pre className="text-[10px] font-mono text-cyan-700 dark:text-cyan-400 whitespace-pre-wrap">
                  {chain.input}
                </pre>
              </div>
            </div>
