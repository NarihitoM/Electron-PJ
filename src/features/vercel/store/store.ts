...
import type { VercelClientState, vercelcrondata } from "../types/type";

export const initialVercelCron: vercelcrondata = {
  isActive: false,
  model: "",
  provider: "",
  message: "",
...
export const vercelauthstore = create<VercelClientState>((set) => ({
  ...
  setVercelcron: (v) => set({ vercelcron: v }),
