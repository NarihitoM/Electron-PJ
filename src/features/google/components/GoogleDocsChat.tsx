...
import { GoogleDocsMessageList } from "./GoogleDocsMessageList";
import { GoogleDocsInput } from "./GoogleDocsInput";
import { GoogleDocsConnectionPanel } from "./GoogleDocsConnectionPanel";

export const GoogleDocsChat = () => {
  ...
  return (
    <>
      ...
      <ImageLightbox
        images={store.lightboxImages_docs}
        initialIndex={store.lightboxIndex_docs}
        open={store.lightboxOpen_docs}
        onOpenChange={store.setLightboxOpen_docs}
      />
    </>
  );
};
