                    ...
                    >
                      {msg.thinking && (
                        <ThinkingBlock
                          ...
                          isStreaming={
                            store.sending_sheet && index === store.sessionmessage_sheet.length - 1
                          }
                        />
                      )}
                      <motion.div
                                ...
                                <CollapsibleTrigger asChild>
                                  ...
                                  >
                                    ...
                                    {tool.status === "loading" ? (
                                      ...
                                      <span>{Googlesheettool[tool.name.toLowerCase()]}</span>
                                    )}
                                    {tool.status !== "loading" && (
                                      <ChevronDown
                                        size={15}
                    ...
                    {msg.content && (
                      <button
                        onClick={() => {
                          ...
                          store.setCopiedIndex_sheet(index);
                          setTimeout(() => store.setCopiedIndex_sheet(null), 1500);
                        }}
