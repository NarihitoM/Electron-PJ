    ...
    <Dialog open={opencron} onOpenChange={setopencron} modal={false}>
      <DialogContent className="max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Configure your AI Agent to broadcast messages automatically on a recurring minute
            schedule.
          </DialogDescription>
        </DialogHeader>
                  ...
                  <>
                    {(publichannel.length > 0 ||
                      ...
                      >
                        ...
                        <SelectContent
                          className="p-1 w-60 max-h-68 overflow-y-auto"
                    ...
                    {slackcron.channel === "Public" && publichannel.length > 0 && (
                      <Select
                        ...
                        onValueChange={(val) =>
                          setslackcron((prev) => ({ ...prev, roomId: val ?? "" }))
                        }
                      ...
                      >
                        <SelectTrigger>
                          <span className="truncate">
                            {slackcron.roomId
                              ? selectedPublicchannelcron?.substring(0, 15) + "..."
                    ...
                    {slackcron.channel === "Private" && privatechannel.length > 0 && (
                      ...
                      >
                        <SelectTrigger>
                          <span className="truncate">
                            {slackcron.roomId
                              ? selectedPrivatechannelcron?.substring(0, 15) + "..."
                    ...
                    {slackcron.channel === "Direct message" && im.length > 0 && (
                      ...
                      >
                        <SelectTrigger>
                          <span className="truncate">
                            {slackcron.roomId
                              ? selectedimchannelcron?.substring(0, 15) + "..."
                              : "Select Direct Message Channel"}
                          </span>
                        </SelectTrigger>
                        <SelectContent
                          className="p-1 w-60 max-h-68 overflow-y-auto"
                    ...
                    {slackcron.channel === "Group message" && mpim.length > 0 && (
                      ...
                      >
                        <SelectTrigger>
                          <span className="truncate">
                            {slackcron.roomId
                              ? selectedmpimchannelcron?.substring(0, 15) + "..."
                              : "Select Group Message Channel"}
                          </span>
                        </SelectTrigger>
                        <SelectContent
                          className="p-1 w-60 max-h-68 overflow-y-auto"
                ...
                <div className="relative overflow-visible">
                  ...
                  >
                    {slackcron.model ? (
                      <div className="flex items-center gap-2">
                        <img
                          src={getProviderImage(slackcron.provider || "")}
                          className="bg-white rounded-lg p-0.5 w-5 h-5 object-contain shrink-0"
                        />
                          ...
                          cronModelList
                            ...
                            .map((entry) => (
                              <button
                                ...
                                type="button"
                                onClick={() => {
                                  setslackcron((prev) => ({ ...prev, model: entry.model }));
                                  setModelOpen(false);
                                  setModelSearch("");
                                }}
                ...
                <div className="flex gap-1 flex-wrap">
                  {DAY_NAMES.map((name, index) => (
                    <Button
                      ...
                      className={
                        customDayOfWeek.includes(index)
