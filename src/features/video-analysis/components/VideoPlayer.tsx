    ...
    return (
        <div className="relative w-full h-full flex flex-col group gap-4">
                                ...
                                {modelList.filter((entry) =>
                                    ...
                                    modelList.filter((entry) =>
                                        ...
                                        <button
                                            key={entry.model}
                                            type="button"
                                            onClick={() => { setModel(entry.model); setmodelOpen(false); setModelSearch(""); }}
            ...
            <div className="flex px-2 gap-2">
                ...
                {Api.length > 0 &&
                    <Button onClick={() => generateTranscript?.()} disabled={isPending || loadingupload || !model || !provider} className="bg-cyan-500 dark:bg-white">{
